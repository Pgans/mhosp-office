...
$this->title = 'ข้อมูลการปิดสิทธิ์ การใช้ยาสมุนไพร แพทย์แผนไทย';
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
				  ...
				  <div style="text-align: right;">
                <a href="<?= Url::to(['closefdh32/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhhurb/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                       ...
                       <?= Html::a('Export', ['closefdh32/exports'], ['class' => 'btn btn-success']) ?>
...
<div class="card">
 ...
 <div style="font-size: 2.2rem; font-weight: bold; color: deeppink;">
        ปิดสิทธิ์การจ่ายยาสมุนไพร แพทย์แผนไทย
    </div>
...
<?php
$url = Url::to(['closefdh32/read-smart-card']);
$js = <<<JS
...
?>
 ...
 <?= Html::beginForm(['closefdh32/check'], 'post', ['name' => 'frmMain', 'id' => 'frmMain']); ?>
...
<div style="overflow: auto; height: 600px; border: 1px solid #ddd;">
            ...
            <?php if ($visitProvider && $visitProvider->getCount() > 0): ?>
                <?php foreach ($visitProvider->getModels() as $key => $value) : ?>
                    <tr>
                        ...
                        <td><?= $value["age"]; ?></td>
						<td style="color: #068cc4;"><?= $value["dru_name"]; ?></td>
    ...
    <?= Html::beginForm(['closefdh32/check'], 'post', ['id' => 'fdhForm']) ?>
...
<td>
    ...
    <?= Html::a('GET', ['closefdh32/check-nhso', 'cid' => $value['cid'], 'visit_id' => $value['visit'], 'telephone' => $value['telephone']], [
        'class' => 'btn btn-danger',
