...
$this->title = 'VVIP-ยอดชดเชยจาก สปสช.';
...
<br>
    <div style="background: linear-gradient(135deg, #8560fc, #faf0fc); 
            padding: 10px; 
            border: 0px solid #b39dfa;">

    <h4><a style="color: white;" href="#">ผู้มารับบริการศูนย์ตรวจสุขภาพ-พิเศษ  แสดงสิทธิ์การรักษา ราคา และยอดชดเชยจาก สปสช.</h4>
</div>

<div class='well' style="background-color: #faf0fc; color: #000; padding: 15px; border-radius: 15px;">
    <?= Html::beginForm(['vvip'], 'get', ['class' => 'd-flex align-items-center justify-content-between flex-wrap']) ?>
...
echo GridView::widget([
    ...
    'tableOptions' => [
		 ...
		 'panel' => [
            'before'=>'<b style="color:green">VIP </b>',
   ...
   [
    ...
    'value' => function ($model, $key, $index) use ($dataProvider) {
        ...
        return $dataProvider->totalCount - ($page * $pageSize + $index);
					...
					[
                        'attribute' => 'appove code EDC',
                        'header' => 'appove code EDC',
						'footer' => 'รวมทั้งหมด',
						'headerOptions' => ['style' => 'background-color:#faf0fc'],
					...
					[
                        'attribute' => 'ยอดออกใบเสร็จ',
                        'header' => 'ยอดออกใบเสร็จ',
						'pageSummary' => true,
						'headerOptions' => ['style' => 'background-color:#faf0fc'],
                    ],
					[
                        'attribute' => 'ยอดเคลมชดเชย',
                        'header' => 'ยอดเคลมชดเชย',
						'pageSummary' => true,
						'headerOptions' => ['style' => 'background-color:#faf0fc'],
                    ],
					[
                        'attribute' => 'บริการนอก/ใน รพ.',
                        'header' => 'บริการนอก/ใน รพ.',
						'headerOptions' => ['style' => 'background-color:#faf0fc'],
                    ],
