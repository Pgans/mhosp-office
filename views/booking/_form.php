    ...
    <div class="box-body">  
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                ['value' => !empty($model->booking_status_id) #? $model->booking_status_id : 1
				]);
                ?>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?=
                $form->field($model, 'booking_room')->dropDownList(ArrayHelper::map(Room::find()->where(['is_cancel' => 1])->all(), 'room_id', 'room_name'), [
                    'prompt' => 'กรุณาเลือก ...',
                ])
                ?>
            </div>
        ...
        <div class="col-md-4"> 
            <div class="form-group">
                <?=
                $form->field($model, 'departments_id')->dropDownList(ArrayHelper::map(Departments::find()->all(), 'dep_id', 'dep_name'),
                 [
                    'prompt' => 'กรุณาเลือก ...',
                ])
                ?>
