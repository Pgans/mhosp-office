            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-info">
                        <div class="panel-heading"><i class="glyphicon glyphicon-user"></i> การจัดซื้อใหม่อุปกรณ์ประเภทหมึก</<i></div>
                        <div class="panel-body">
                            <div>
...
";
        ...
        <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading"><i class="glyphicon glyphicon-list-alt"></i> การจัดซื้อใหม่อุปกรณ์ประเภทหมึก</<i></div>
                        <div class="panel-body">
                            <div>
                                 <?php
                                Pjax::begin();
