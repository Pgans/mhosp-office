        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                <span class="info-box-icon"><i class="far fa-calendar-check" style="color: green;"></i></span>
					...
					<span class="info-box-text" style="color: green; font-size: 18px;">ยอดบริการวันนี้ <?php echo "ทั้งหมด:$todayopd "; ?>ราย</span>
					<span class="info-box-number">
						<?php
						echo "<a>ขอAuthen:</a> <span style='color:green;'>$authen</span> | <a>เหลือ:</a> <span style='color:orange;'>$noauthen</span>";
						?>
					<div>
					<?php echo "<a>ต่างด้าว:</a> $alien"; ?> |
					<?php echo "<a>homeward:</a> $homeward"; ?>
					</div>
					</div>
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
						<?php
						echo "<a>ปิดสิทธิ์:</a> <span style='color:green;'>$closevisit</span> | <a>เหลือ:</a> <span style='color:orange;'>$noclosevisit</span>";
						?>					
					</span>
                </div>
...
<div class="card">
 ...
 <div class="card-body" style="display: flex; align-items: center; gap: 20px;">
    ...
    <div style="font-size: 2.2rem; font-weight: bold; color: deeppink;">
       ขอ Authen ปิดสิทธิ์ สำหรับ Admin
    </div>
    ...
    <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" 
        ...
        <thead style="position: sticky; top: 0; background-color: #fff; z-index: 1;">
           <tr>
                ...
                <th>ชื่อ-สกุล</th>
                <th>อายุ</th>
                <th><?= $visitProvider->sort->link('unit_name') ?></th>
        ...
        <?php foreach ($visitProvider->getModels() as $key => $value) : ?>
            <tr data-visit="<?= $value["visit"] ?>">
               <td><?= $value["No"]; ?></td>
				...
				<?= Html::beginForm(['closeall/check1'], 'post', ['id' => 'fdhForm1_' . $key, 'class' => 'fdhForm1']) ?>
                ...
                <td>
                    <?= Html::beginForm(['closeall/check'], 'post', ['id' => 'fdhForm_' . $key, 'class' => 'fdhForm']) ?>
                ...
                <td>
                    <?= Html::a('GET', ['closeall/check-nhso', 
                        'cid' => $value['cid'], 
...
<div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
    <!-- กลับหน้าหลัก -->
    <div>
        <?= Html::a('⏪ กลับหน้าหลัก', ['site/index'], [
