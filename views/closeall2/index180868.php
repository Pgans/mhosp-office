        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
						<?php
						echo "<a>ปิดสิทธิ์:</a> <span style='color:green;'>$closevisit</span> | ";
...
<div class="card-body" style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
    ...
    <?= Html::a('⏪ กลับหน้าหลัก', ['closeall/index'], [
        ...
        'style' => 'font-size: 1.5rem; padding: 10px 20px; border-radius: 30px; background-color: #eee; border: 1px solid #ccc;'
    ]) ?>

    <!-- ข้อความขอ Authen -->
    <div style="font-size: 2.2rem; font-weight: bold; color: deeppink;">
       ขอAuthen ปิดสิทธิ์ที่ยังว่าง 
    </div>
