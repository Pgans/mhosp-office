...
$this->title = 'ข้อมูลการปิดสิทธิ์ ER';
...
.my-striped-table tbody tr:hover {
    ...
    <div class="row">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['closeer/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['closeer/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['closeer/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhhurb/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                       ...
                       <?= Html::a('Export', ['closeer/exports'], ['class' => 'btn btn-success']) ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['closeer/index']]); ?>
...
<?php
$url = Url::to(['closeer/read-smart-card']);
$js = <<<JS
...
?>
 ...
 <?= Html::beginForm(['closeer/check'], 'post', ['name' => 'frmMain', 'id' => 'frmMain']); ?>
...
<div style="overflow: auto; height: 600px; border: 1px solid #ddd;">
    ...
    <?= Html::beginForm(['closeer/check'], 'post', ['id' => 'fdhForm']) ?>
...
<td>
    ...
    <?= Html::a('GET', ['closeer/check-nhso', 'cid' => $value['cid'], 'visit_id' => $value['visit'], 'telephone' => $value['telephone']], [
        'class' => 'btn btn-danger',
