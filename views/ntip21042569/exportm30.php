...
$this->title = 'ไฟล์นำเข้าโปรแกรม Ntip บุคลาการสาธารณสุขดูแลผู้ป่วย';
...
<br>
    <div style="background-color: #07a39e; padding: 10px; border: 0px solid #D4F1F5;">
    <h4><a style="color: white;" href="#">ส่งออกไฟล์ Excel นำเข้า Ntip บุคลาการสาธารณสุขดูแลผู้ป่วย</h4>
</div>
...
echo GridView::widget([
        ...
        'panel' => [
            'before'=>'<b style="color:green">ไฟล์ Excel สำหรับน่ำเข้าโปแกร Ntip บุคลาการสาธารณสุขดูแลผู้ป่วย </b>',
