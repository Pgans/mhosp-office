	...
	public function search($params)
{
    ...
    // ตรวจสอบคัดกรองข้อมูลที่มี send_date อยู่ในช่วง 1 วันที่ผ่านมา
    $query->andFilterWhere([
        'DATE(send_date)' => new \yii\db\Expression('DATE(NOW())') // ตรวจสอบวันที่ตรงกับวันนี้
    ]);

    // คัดกรอง messagecode ที่ไม่เท่ากับ 'success'
    $query->andFilterWhere(['<>', 'messagecode', 'success']);
