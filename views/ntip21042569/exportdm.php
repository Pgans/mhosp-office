...
<br>
    ...
    <h4><a style="color: white;" href="#">ส่งออกไฟล์ Excel นำเข้า Ntip  อายุมากกว่า = 65 ปี</h4>
</div>
...
echo GridView::widget([
        ...
        'panel' => [
            'before'=>'<b style="color:green">ไฟล์ Excel สำหรับน่ำเข้าโปแกร Ntip โรคเบาหวาน </b>',
