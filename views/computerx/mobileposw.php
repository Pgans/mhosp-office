...
<div class="col-md-6">
    <div class="panel panel-default" 
     style="border: none; border-radius: 15px; box-shadow: 0 6px 20px rgba(156, 39, 176, 0.2);">
     
    <!-- Panel Heading -->
    <div class="panel-heading" 
         style="background: linear-gradient(90deg, #E6CCFF, #D1B3FF); 
                color: #4A148C; 
                font-weight: bold; 
                font-size: 16px; 
                border-radius: 15px 15px 0 0; 
                box-shadow: inset 0 -2px 6px rgba(0,0,0,0.1);">
        <i class="glyphicon glyphicon-list-alt"></i> ข้อมูลหน่วยเคลื่อนที่ พอสว. โรงพยาบาลม่วงสามสิบ
    </div>
    
    <!-- Panel Body -->
    <div class="panel-body" 
         style="background: linear-gradient(180deg, #F3E5F5, #EDE7F6); 
                border-radius: 0 0 15px 15px; 
                padding: 15px;">
        <!-- ใส่ตารางหรือกราฟที่นี่ -->
                ...
                FROM 
                    (SELECT 
                     ...
                     WHERE 
                         o.unit_reg = '80'  
                         AND o.is_cancel = 0
                         AND o.REG_DATETIME BETWEEN '2025-09-4 00:01' AND '2025-09-28 23:59'
                     GROUP BY 
                         o.visit_id  
                    ) AS k
                GROUP BY 
...
$this->registerJs("
    $(function () {
        Highcharts.chart('chart-container', {
            ...
            title: {
                text: 'สถิติการลงทะเบียนและบริการ (4 กันยายน 2568)'
            },
            xAxis: {
