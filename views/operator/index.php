                    ...
                    [
                        ...
                        'buttons'=>[
                                    'view' => function($url,$model,$key){
                                        return Html::a('<i class="glyphicon glyphicon-eye-open"></i>',['operator/view','id'=>$model->booking_id]);
                                    }
                            ]
                    ],
                    [
                        ...
                        'buttons'=>[
                                    'view' => function($url,$model,$key){
                                        return Html::a('<i class="glyphicon glyphicon-eye-open"></i>',['operator/update','id'=>$model->booking_id]);
                                    }
                            ]
                    ],
					*/
