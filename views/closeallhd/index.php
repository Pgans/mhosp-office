...
$this->title = 'PG0130001 = บริการฟอกเลือดด้วยเครื่องไตเทียม (HD)  ';
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
						<?php
						echo "<a>ไตเทียม:</a> <span style='color:green;'>$closevisits</span> | ";
						echo "<a href='index.php?r=closeallhd/index' style='color:orange;'>เหลือ: $noclosevisit</a>";
						?>
				
					</span>
                </div>
               <div style="text-align: right;">
                <a href="<?= Url::to(['closeallhd/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
...
">
   Authen API--สปสช. --บริการฟอกเลือดด้วยเครื่องไตเทียม
</div>
...
<?php
$url = Url::to(['closeall3/read-smart-card']);
$js = <<<JS
        ...
        <?php if ($visitProvider && $visitProvider->getCount() > 0): ?>
            ...
            <?php foreach ($models as $key => $value) : ?>
                <tr data-visit="<?= $value["visit"] ?>">
					...
					<!--
                    <td>
                        <?= Html::beginForm(['closeallhd/check1'], 'post', [
                            'id' => 'fdhForm1_' . $key,
                            'class' => 'fdhForm1'
                        ]) ?>
                    ...
                    <!-- ✅ ปุ่มปิดสิทธิ์ -->
                    <td>
                        <?= Html::beginForm(['closeallhd/check'], 'post', [
                            'id' => 'fdhForm_' . $key,
                            'class' => 'fdhForm'
                        ]) ?>
