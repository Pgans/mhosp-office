...
$this->title = 'ไฟล์นำเข้าโปรแกรม Ntip ออกตรวจนอกหน่วยบริการคลินิกวัณโรค xray';
...
<br>
    <div style="background-color: #079ab8; padding: 10px; border: 0px solid #D4F1F5;">
    <h4><a style="color: white;" href="#">ส่งออกไฟล์ Excel นำเข้า Ntip ตรวจนอกหน่วยบริการคลินิกวัณโรค xray</h4>
</div>
...
echo GridView::widget([
        ...
        'panel' => [
            'before'=>'<b style="color:green">ไฟล์ Excel สำหรับน่ำเข้าโปแกร Ntip ตรวจนอกหน่วยบริการคลินิกวัณโรค xray </b>',
