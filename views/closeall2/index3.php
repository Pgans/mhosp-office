...
.my-striped-table tbody tr:hover {
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['closephysical/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['closephysical/index']]); ?>
                ...
                <?php foreach ($visitProvider->getModels() as $key => $value) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?= Html::hiddenInput('visit', $value["visit"]); ?>
