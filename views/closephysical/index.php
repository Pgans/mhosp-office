...
$this->title = 'ข้อมูลการปิดสิทธิ์ กายภาพบำบัด';
...
?>
 ...
 <?= Html::beginForm(['closephysical/check'], 'post', ['name' => 'frmMain', 'id' => 'frmMain']); ?>
...
<div style="overflow: auto; height: 600px; border: 1px solid #ddd;">
    ...
    <?= Html::beginForm(['closephysical/check'], 'post', ['id' => 'fdhForm']) ?>
...
<td>
    ...
    <?= Html::a('GET', ['closephysical/check-nhso', 'cid' => $value['cid'], 'visit_id' => $value['visit'], 'telephone' => $value['telephone']], [
        'class' => 'btn btn-danger',
