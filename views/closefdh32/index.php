...
$this->title = 'ข้อมูลการปิดสิทธิ์ แพทย์ทางเลือกจ่ายยาสมุนไพร';
...
echo "<a style='color:orange;'>เหลือ: $noauthen</a>";
?>
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
						...
						echo "<a  style='color:orange;'>เหลือ: $noclosevisit</a>";
						?>
				
					</span>
                </div>
               <div style="text-align: right;">
                <a href="<?= Url::to(['closefdh32/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['closefdh32/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
...
<div class="card-body" style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
    ...
    <button id="read-card" class="btn btn-success" 
        style="background: linear-gradient(135deg, #9467f5, #6a5acd);
...
">
   Authen API--สปสช. --แพทย์ทางเลือกจ่ายยาสมุนไพร
</div>
        ...
        <?php if ($visitProvider && $visitProvider->getCount() > 0): ?>
            ...
            <?php foreach ($models as $key => $value) : ?>
                <tr data-visit="<?= $value["visit"] ?>">
                    ...
                    <!-- ✅ ปุ่ม authen -->
                    <td>
                        <?= Html::beginForm(['closefdh32/check1'], 'post', [
                            'id' => 'fdhForm1_' . $key,
                            'class' => 'fdhForm1'
                        ]) ?>
                    ...
                    <!-- ✅ ปุ่มปิดสิทธิ์ -->
                    <td>
                        <?= Html::beginForm(['closefdh32/check'], 'post', [
                            'id' => 'fdhForm_' . $key,
                            'class' => 'fdhForm'
                        ]) ?>
