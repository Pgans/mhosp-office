...
$this->title = 'VIP-ยอดชดเชยจาก สปสช.';
...
<br>
    ...
    <h4><a style="color: white;" href="#">ผู้มารับบริการศูนย์ตรวจสุขภาพ  แสดงสิทธิ์การรักษา ราคา และยอดชดเชยจาก สปสช.</h4>
</div>

<div class='well' style="background-color: #faf0fc; color: #000; padding: 15px; border-radius: 15px;">
    <?= Html::beginForm(['vip'], 'get', ['class' => 'd-flex align-items-center justify-content-between flex-wrap']) ?>
