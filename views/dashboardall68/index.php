...
html, body {
    ...
    margin: 0;
    padding: 0;
    background-color: #595859!important; /* สีม่วงอ่อน */
}
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; width: 100%;">
    <h3 style="margin: 0; padding: 0; color: white;">📊 กราฟผู้ป่วย OPD / IPD  ปีงบประมาณ 2568</h3>
...
<div class="col-md-6">
    <div class="card p-3 shadow-sm rounded">
        <h4 class="text-center text-primary mb-3">
            <i class="fas fa-chart-bar"></i> บริการทันตกรรม โรงพยาบาลม่วงสามสิบ(DENTAL)
        </h4>
...
<div class="col-md-6">
   <div class="card p-3 shadow-sm rounded">
        <h4 class="text-center text-primary mb-3">
            <i class="fas fa-chart-pie"></i> การบริการทันตกรรม (ปีงบ 2568)
        </h4>
