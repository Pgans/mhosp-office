...
class Closeall3yController extends \yii\web\Controller
{
      ...
      AND ISNULL(cv.claimcode)
	   AND COALESCE(
        (cg01 + cg02 + cg03 + cg04 + cg05 + cg06 + cg07 + cg08 + cg09 + cg10 +
         cg11 + cg12 + cg13 + cg14 + cg15 + cg16 + cg17 + cg18 + cg19), 0
      ) <> 0     -- ✅ amount ไม่เท่ากับ 0.00
  AND NOT (
        p.cid REGEXP '^0{5,}'
        OR ak.claimcode IS NULL 
        OR TRIM(ak.claimcode) = ''
  )
    GROUP BY a.visit_id
    ORDER BY 
