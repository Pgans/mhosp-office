...
<div class="jobcom-index" style="font-family: 'Sarabun', sans-serif; font-size: 15px; background-color: #f8fafb; padding: 10px;">
    ...
    'rowOptions' => function($model, $key, $index, $grid) {
        if ($index % 2 == 0) {
            ...
            return ['style' => 'background-color: #f9f9f9;']; // แถวคู่สีเทาจาง (สลับสี)
        }
    },
...
<style>
    ...
    .table thead th {
        ...
        background: #f9fbfd !important; /* บังคับสีหัวตารางให้สว่าง */
    }

    /* สีของแถวที่สลับ (Striped) */
    .table-striped > tbody > tr:nth-of-type(odd) {
        background-color: #ffffff; /* แถวคี่สีขาว */
    }
    .table-striped > tbody > tr:nth-of-type(even) {
        background-color: #fcfcfc; /* แถวคู่สีเทาจางมาก ๆ */
    }

    /* เมื่อเอาเมาส์ไปชี้ (Hover) ให้เปลี่ยนเป็นสีฟ้าอ่อนเหมือนเดิม */
