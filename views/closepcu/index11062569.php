                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['closepcu/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"> 0</span>
						  ...
						  <div style="text-align: right;">
                <a href="<?= Url::to(['closepcu/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
...
?>
 ...
 <?= Html::beginForm(['closepcu/check'], 'post', ['name' => 'frmMain', 'id' => 'frmMain']); ?>
...
<div style="overflow: auto; height: 600px; border: 1px solid #ddd;">
    ...
    <?= Html::beginForm(['closepcu/check'], 'post', ['id' => 'fdhForm']) ?>
...
<td>
    ...
    <?= Html::a('GET', ['closepcu/check-nhso', 'cid' => $value['cid'], 'visit_id' => $value['visit'], 'telephone' => $value['telephone']], [
        'class' => 'btn btn-danger',
