...
$this->title = 'ข้อมูลการปิดสิทธิ์ ศูนย์สุขภาพชุมชนม่วงสามสิบ';
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['closepcu/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['closepcu/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
...
">
   Authen API--สปสช. -- ศูนย์สุขภาพชุมชนม่วงสามสิบ
</div>
...
<?php
$url = Url::to(['closepcu/read-smart-card']);
$js = <<<JS
        ...
        <?php if ($visitProvider && $visitProvider->getCount() > 0): ?>
            ...
            <?php foreach ($models as $key => $value) : ?>
                <tr data-visit="<?= $value["visit"] ?>">
                    ...
                    <!-- ✅ ปุ่ม authen -->
                    <td>
                        <?= Html::beginForm(['closepcu/check1'], 'post', [
                            'id' => 'fdhForm1_' . $key,
                            'class' => 'fdhForm1'
                        ]) ?>
                    ...
                    <!-- ✅ ปุ่มปิดสิทธิ์ -->
                    <td>
                        <?= Html::beginForm(['closepcu/check'], 'post', [
                            'id' => 'fdhForm_' . $key,
                            'class' => 'fdhForm'
                        ]) ?>
