            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhhurb/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
					  ...
					  <?= Html::a('📤 ส่งออก TextFile', ['authents/export-authen'], ['class' => 'btn btn-success']) ?>
                      <?= Html::a('📥 นำเข้า TextFile', ['authents/import-authen'], ['class' => 'btn btn-primary']) ?>
...
<div class="card">
    ...
    <div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
        <button id="read-card" class="btn btn-success" 
            style="background-color: #ab4bfa; border: 4px solid #dadada; padding: 10px 20px; border-radius: 30px; 
...
<div style="overflow: auto; height: 600px; border: 1px solid #ddd;">
    ...
    <?= Html::beginForm(['authen/check'], 'post', ['id' => 'fdhForm']) ?>
        <?= Html::hiddenInput('visit', $value["visit"], ['id' => 'visitInput']); ?>
        
        <!-- ปุ่ม submit ส่งข้อมูลไปยัง API actionCheck -->
        <?= Html::submitButton('authen', [
            'class' => 'btn btn-danger', 
            'style' => 'background-color: #ab4bfa; border: 4px solid #dadada; padding: 10px 20px; border-radius: 30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); font-size: 1.2rem; text-transform: uppercase; cursor: pointer; width: auto;',
        ]); ?>
    <?= Html::endForm(); ?>
</td>
