            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                <span class="info-box-icon"><i class="far fa-calendar-check" style="color: green;"></i></span>
					...
					<span class="info-box-number">
						<?php
echo "<a>ขอAuthen:</a> <span style='color:green;'>$amount</span> | ";
echo "<a href='index.php?r=authen/index' style='color:orange;'>เหลือ: $amountx</a>";
?>
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
						...
						echo "<a href='index.php?r=closeall2/index' style='color:orange;'>เหลือ: $total</a>";
						?>
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number" style="color: green; font-size: 18px;">mBase</span>
						<?php
						echo "<strong><a>จองเคลม:</a></strong> <span style='color:green; font-weight:bold;'>$jongclaim</span> | <strong><a>เหลือ:</a></strong> <span style='color:orange; font-weight:bold;'>$nojongclaim</span>";
						?>
						<br>
						<?php
...
<strong><a>จองเคลม:</a></strong> 
<span style='color:green; font-weight:bold;'><?= $claimj ?? 0 ?></span> | 
<strong><a>เหลือ:</a></strong> 
<span style='color:orange; font-weight:bold;'><?= $nojongclaimj ?? 0 ?></span>
<br>

<strong><a>authen:</a></strong> 
<span style='color:green; font-weight:bold;'><?= $authenj ?? 0 ?></span> | 
<strong><a>เหลือ:</a></strong> 
<span style='color:orange; font-weight:bold;'><?= $noauthenj ?? 0 ?></span>
<br>

<strong><a>ปิดสิทธิ์:</a></strong> 
<span style='color:green; font-weight:bold;'><?= $closej ?? 0 ?></span> | 
<strong><a>เหลือ:</a></strong> 
<span style='color:orange; font-weight:bold;'><?= $noclosevisitj ?? 0 ?></span>
...
<br>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; background-color: #fff0f5; padding: 10px 20px; border-radius: 10px; font-family: 'Sarabun', sans-serif; font-weight: bold; font-size: 2.2rem; color: deeppink; white-space: nowrap;">
    <div>💳 ขอ Authen ปิดสิทธิ์</div>
    ...
    <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
        <thead style="position: sticky; top: 0; background-color: #fff; z-index: 1;">
           <tr data-visit="<?= $value['visit'] ?>">
                ...
                <th>ชื่อ-สกุล</th>
                <th>อายุ</th>
               <th>เแผนกลงทะเบียน</th>
				<th>แผนกสุดท้าย</th>
                <th><?= $visitProvider->sort->link('icd10_tm') ?></th>
                <th>เบอร์โทร</th>
                <th>สิทธิ์</th>               
                <th>authen</th>
				<th>ปิดสิทธิ์</th>
            ...
            <?php foreach ($models as $key => $value) : ?>
               <td><?= $value["No"]; ?></td>
                    ...
                    <td style="<?= ($cidCounts[$value['cid']] > 1) 
						...
						<td style="<?= $value["units"] !== 'สิ้นสุดบริการ' ? 'color:red;' : ''; ?>">
							<?= $value["units"]; ?>
						</td>
				      ...
				      <!-- ✅ ปุ่ม authen -->
                    <td>
                        <?= Html::beginForm(['closeall/check1'], 'post', [
                            'id' => 'fdhForm1_' . $key,
                            'class' => 'fdhForm1'
                        ]) ?>
                    ...
                    <!-- ✅ ปุ่มปิดสิทธิ์ -->
                    <td>
                        <?= Html::beginForm(['closeall/check'], 'post', [
                            'id' => 'fdhForm_' . $key,
                            'class' => 'fdhForm'
                        ]) ?>
...
<div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
    ...
    <div style="
        ...
        min-width: 260px;
    ">
        <h4 style="margin-top: 0; margin-bottom: 10px; color: #6f42c1;">📝 ขั้นตอนการใช้งาน</h4>
        <ol style="margin: 0; padding-left: 20px;">
            <li>เสียบบัตรประชาชนเข้ากับเครื่องอ่าน</li>
            <li>กดปุ่ม "📟 อ่านบัตรประจำตัวประชาชนสำหรับเจ้าหน้าที่"</li>
            <li>กดปุ่มรัน Token-Pgans</li>
            <li>กดปุ่ม GET เพื่อตรวจสอบว่าเคยขอหรือยัง ถ้าปิดสิทธิ์แล้วระบบจะนำข้อมูลมาเติมให้ในช่อง Endpoint</li>
			<li>กดปุ่มปิดสิทธิ์ เมื่อยังไม่เคยขอ</li>
			<!--<li style="color:red;">เงื่อนไข::: ตัดรายการผู้ป่วยใน</li>-->
        </ol>
    </div>
</div>
