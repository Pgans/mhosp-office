    ...
    'columns' => [
        ...
        [
           // 'label' => 'รายการ Subagenda',
            'format' => 'raw',
            'value' => function ($model) use ($meetingAgenda, $id) {
                if ($model->agenda_id === 3) {
                    $dataProvider = new \yii\data\ActiveDataProvider([
                        'query' => agendasubx::find()->where(['agenda_id' => $model->agenda_id,'meeting_id' => $model->meeting_agenda_id ]),
                    ]);
                            ...
                            [
                                ...
                                'buttons' => [
                                    'view' => function ($url, $model) {
                                        //return Html::a($model->filename, ['agendasubx/view-file', 'id' => $model->sub_id], ['class' => 'btn btn-success', 'target' => '_blank']);
                                        //return Html::a('เอกสาร', ['agendasubx/view-file', 'id' => $model->sub_id], ['class' => 'btn btn-success', 'target' => '_blank']);
                                       //return Html::a('เอกสาร ' . pathinfo($model->filename, PATHINFO_EXTENSION), ['agendasubx/view-file', 'id' => $model->sub_id], ['class' => 'btn btn-success', 'target' => '_blank']);
