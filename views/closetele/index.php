...
$this->title = 'ข้อมูลการปิดสิทธิ์ Telemed';
...
.my-striped-table tbody tr:hover {
    ...
    <div class="row">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['closetele/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['closetele/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['closetele/index']]); ?>
...
<?php
$url = Url::to(['closetele/read-smart-card']);
$js = <<<JS
...
<?= Html::beginForm(['closetele/check'], 'post', ['name' => 'frmMain', 'id' => 'frmMain']); ?>
...
<div style="overflow: auto; height: 600px; border: 1px solid #ddd;">
    ...
    <?= Html::beginForm(['closetele/check'], 'post', ['id' => 'fdhForm']) ?>
    ...
    <?= Html::a('GET', ['closetele/check-nhso', 'cid' => $value['cid'], 'visit_id' => $value['visit'], 'telephone' => $value['telephone']], [
