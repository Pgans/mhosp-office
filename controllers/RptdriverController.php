...
//use kartik\mpdf\Pdf;
class RptdriverController extends \yii\web\Controller
{
    ...
    public function actionNext() {
         ...
         */
        $sql = "
        SELECT v.license, d.driver_name,
        r.date_start AS start,
        r.date_end AS end,
        p.firstname AS fn,
        p.lastname AS ln
    ...
    public function actionReport() {
        ...
        $sql = "SELECT COUNT(d.driver_id) AS counter, d.driver_name
        FROM rental r
        INNER JOIN drivers d ON d.driver_id = r.driver_id
                WHERE MONTH(r.date_start)= '" . $m . "' AND YEAR(r.date_start) = '" . $y . "' AND r.status = '1'
                GROUP BY d.driver_id  ORDER BY counter DESC
                ";
        ...
        $dataProvider = new ArrayDataProvider([
            'allModels' => $data,
            'sort' => [
                'attributes' => ['driver_name', 'counter']
            ]
        ]);
    ...
    public function actionReportall() {
        ...
        $dataProvider = new ArrayDataProvider([
            'allModels' => $data,
            'sort' => [
                'attributes' => ['driver_name','r1', 'r2', 'r3', 'r4', 'r5', 'r6', 'r7', 'r8', 'r9', 'r10', 'r11', 'r12',]
            ]
        ]);
