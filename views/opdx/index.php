...
<div class="col-md-12">
    <div class="form-group form-inline" 
         style="border:1px solid #ccc; border-radius:8px; padding:10px; background:#e6f2ff;">
        <?= Html::radioList('diag', Yii::$app->request->get('diag', 'SPECIFIC'), [ 
            'ALL' => 'ทั้งหมด',
            'SPECIFIC' => 'โรคหลัก', 
        ], [
            'class' => 'mr-3',
...
<div class="col-md-12">
    <div class="form-group form-inline" 
        ...
        <?= Html::radioList('mobile', Yii::$app->request->get('mobile', 'ALL'), [
            ...
            'class' => 'mr-3',
            'separator' => '   ', // ช่องว่างระหว่าง radio
        ]) ?>
    </div>
</div>
...
<style>
.btn-custom {
    background-color: #8e44ad; /* ม่วงเข้ม */
    color: white;
    border: 2px solid white;
    border-radius: 12px;
    padding: 10px 20px;
    font-weight: bold;
    box-shadow: 0 4px 6px rgba(0,0,0,0.2); /* นูน */
    transition: 0.3s ease;
}
.btn-custom:hover {
    background-color: #9b59b6; /* ม่วงอ่อนขึ้นเมื่อ hover */
    color: white;
}
</style>
