...
class ClosepcuController extends \yii\web\Controller
{
  ...
  public function actionIndex()
{
    ...
    $sql = "SELECT 
            ...
            FROM (
				...
				LEFT JOIN authen_kiosk ak ON ak.visit_id = a.visit_id AND ak.visit_id = a.visit_id
    ...
    $visitProvider = new \yii\data\ArrayDataProvider([
		...
		WHERE o.REG_DATETIME BETWEEN DATE_SUB(NOW(), INTERVAL 1 DAY) AND NOW()
		AND o.unit_reg = '45' 
        AND p.NATN_ID = 99
        AND o.is_cancel = 0
   ...
   public function actionReadSmartCard()
{
    ...
    // API URL
    $url = 'http://192.168.201.122:8189/api/smartcard/read';
...
{
	$pid = Yii::$app->session->get('pid', '1341401242214');
    /*
