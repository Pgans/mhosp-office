...
$this->title = 'ข้อมูลการปิดสิทธิ์ แพทย์แผนไทย';
...
<div class="card">
  ...
  <div class="card-body" style="display: flex; align-items: center; gap: 20px;">
    <button id="read-card" class="btn btn-success" 
        style="background-color: #a229e3; border: 4px solid #dadada; padding: 10px 20px; border-radius: 30px; 
    ...
    <div style="font-size: 2.2rem; font-weight: bold; color: #05b359;">
        ปิดสิทธิ์หัตถการ แพทย์แผนไทย
    </div>
...
?>
 ...
 <?= Html::beginForm(['closefdh/check'], 'post', ['name' => 'frmMain', 'id' => 'frmMain']); ?>
...
<div style="overflow: auto; height: 600px; border: 1px solid #ddd;">
    ...
    <?= Html::beginForm(['closefdh/check'], 'post', ['id' => 'fdhForm']) ?>
...
<td>
    ...
    <?= Html::a('GET', ['closefdh/check-nhso', 'cid' => $value['cid'], 'visit_id' => $value['visit'], 'telephone' => $value['telephone']], [
        'class' => 'btn btn-danger',
