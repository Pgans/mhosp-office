...
<div class="container-fluid">
    ...
    ผลลัพธ์รายงานบริการส่งต่อผู้ป่วยนอก 
    ...
    <?php endif; ?></h4>
        ...
        'panel' => [
            ...
            'after'=>'ประมวลผล '.date('Y-m-d H:i:s')
                            ...
                            'summary' => '<div style="font-size: 1.2rem; font-weight: bold;">แสดง {begin} - {end} จาก {totalCount} รายการ</div>',
     'export' => [
        'fontAwesome' => true, // Use FontAwesome icons for export buttons
        'showConfirmAlert' => false, // Optionally disable the confirmation alert
        'target' => GridView::TARGET_BLANK, // Open in a new window
        'downloadRequest' => 'gridview/export/download', // Ensure this is the correct URL for export
    ],
    'toolbar' => [
