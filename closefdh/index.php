...
<script>
        ...
        document.addEventListener("mouseup", () => {
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <?php foreach ($visitProvider->getModels() as $key => $value) : ?>
                        ...
                        <td><input type="checkbox" name="chkDel[]"  id="chkDel<?= $i; ?>" value="<?php echo $value["visit"]; ?><?php echo $value["hn"]; ?>"style="width: 16px; height: 16px;"></td>
    ...
    <td style="font-size: 14px;"><?php echo $value["visit"]; ?></div>
    </td>
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["inscl_name"]; ?></div></td>
	<td class="text-nowrap" style="font-size: 14px; color: green;">
        <?php echo $value["amount"]; ?>
    </td>
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["claimcode"]; ?></div></td>
    </tr>
<?php endforeach; ?>
</table>
</div>
