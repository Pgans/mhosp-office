    ...
    <div class="row">
        ...
        $reports = [
			...
			[
			 ...
			 ['icon' => 'fas fa-calendar-alt', 'title' => '16. บริการวัยรุ่นและเยาวชน', 'url' => ['/youth/youth-service']],
			 ['icon' => 'fas fa-calendar-alt', 'title' => '17. ExcelNtip คัดกรองวัณโรค', 'url' => ['/ntip/exporttb']],
			 ['icon' => 'fas fa-calendar-alt', 'title' => '18.นำเข้า xray ออกหน่วย', 'url' => 'http://192.168.200.25/check_hn/', 'linkOptions' => ['target' => '_blank']],
			 ['icon' => 'fas fa-calendar-alt', 'title' => '19. Excel Ntipเบาหวาน อายุ <=65 ', 'url' => ['/ntip/exportdm2']],
        ];
    ...
    echo '<div class="col-md-6 col-lg-4 mb-4">
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <h5 class="card-title">'. Html::a($report['title'], $report['url'], $linkOptions) .'</h5>
                </div>
            </div>
        </div>';
}