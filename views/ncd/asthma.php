...
<br>
    ...
    <h4><a style="color: white;" href="#">IP-Asthma รหัสโรค J45-J46</h4>
</div>
...
<div class='well' style="background-color: #E6E6FA;color: darkgreen;">
    <?php $form = ActiveForm::begin(); ?>
     ระหว่างวันที่:
		...
		<input class="btn btn-primary" name="btnButton" type="button" value="พิมพ์" onClick="JavaScript:window.print();">
...
echo GridView::widget([
        ...
        'panel' => [
            'before'=>'<a style="color:green">ผู้ป่วยใน Asthma รหัสโรค J45-J46</a>',
               ...
               'columns' => [
					...
					[
						...
						'value' => function ($model) {
							return '<button class="btn btn-primary" style="background-color:#BA55D0; color:white; font-size:12px;">' 
								. $model['an'] . 
							'</button>';
						},
					],
					...
					[
                        'attribute' => 'dsc_status_name',
                        'header' => 'dsc_status',
						'headerOptions' => ['style' => 'background-color:#E6E6FA'],
						'format' => 'raw', // จำเป็นสำหรับแสดง HTML
						'value' => function ($model) {
							return '<button class="btn btn-primary" style="background-color:#28b463 ; color:white; font-size:12px;">' . $model['dsc_status_name'] . '</button>';
						},
                    ],
					[
						'attribute' => 'dsc_name',
						...
						'format' => 'raw', // จำเป็นสำหรับแสดง HTML
						'value' => function ($model) {
							return '<button class="btn btn-primary" style="background-color:#147FF1; color:white; font-size:12px;">' 
								. $model['dsc_name'] . 
							'</button>';
						},
					],
