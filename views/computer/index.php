...
$this->registerCss("
    ...
    .grad-mint {
        background: linear-gradient(135deg, #8BC34A 0%, #64B5F6 100%);
    }
    
    .grad-rainbow {
        background: linear-gradient(90deg, #CC99FF 0%, #FF6B9D 20%, #FF0000 40%, #FFCC00 60%, #9933FF 80%, #000080 100%);
    }
...
<div class="col-md-6">
    <div class="panel panel-primary">
        <div class="panel-heading" style="background: linear-gradient(90deg, #8BC34A, #64B5F6, #FFEB3B); color: #ffffff;">
            <i class="glyphicon glyphicon-list-alt"></i> จำนวนให้บริการข้อมูล EHR เครือข่ายม่วงสามสิบ
        </div>
        <div class="panel-body">
            <div style="display: none">
                <?php
            ...
            $sql = "SELECT 
                    ...
                    FROM log_ehr lg 
                    WHERE lg.datetime BETWEEN '2019-01-01' AND '2027-12-31'
...
<div class="col-md-6">
    <div class="panel panel-primary">
        <div class="panel-heading" style="background: linear-gradient(90deg, #8BC34A, #64B5F6, #9933FF); color: #000000;">
        ...
        <div class="panel-body">
            ...
            <?php
            $categories = ['2562', '2563', '2564', '2565', '2566', '2567','2568','2569'];
            $opd_data = [95.40, 88.00, 91.33, 0, 92.22, 91.52, 'NA',95.64];
            $ipd_data = [93, 92, 91.65, 0, 87.65, 81.69,78.93,85.97];
            $progress_note_data = [94.56, 92.44, 76.16, 0, 63.42, 80.21,79.01,78.52];
                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr class="info">
                            ...
                            <th class="text-center">Progress Note (%)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($categories as $index => $year): ?>
                        <tr>
                            <td class="text-center"><?= $year ?></td>
                            <td class="text-center"><?= $opd_data[$index] ?></td>
                            <td class="text-center"><?= $ipd_data[$index] ?></td>
                            <td class="text-center"><?= $progress_note_data[$index] ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
