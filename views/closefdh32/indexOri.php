...
$this->title = 'ข้อมูลการปิดสิทธิ์แพทย์แผนไทย';
...
.my-striped-table tbody tr:hover {
    ...
    <div class="row">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['closefdh/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['closefdh/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['closefdh/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['closefdh/index']]); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <button id="read-card" class="btn btn-success">📟 อ่านบัตร</button>
        <div id="result" class="mt-3"></div>
    </div>
</div>

<?php
$url = Url::to(['closefdh/read-smart-card']);
$js = <<<JS
...
<div style="overflow: auto; height: 500px; border: 1px solid #ddd;">
    <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" 
        ...
        <thead>
            <tr>
                <th width="30" style="background-color: lightpink; position: sticky; top: 0; z-index: 2;">
                    <div align="center">
                        <input name="CheckAll" type="checkbox" id="CheckAll" value="Y" onClick="ClickCheckAll(this);">
                    </div>
                </th>
                <th width="30" style="background-color: lightgreen; position: sticky; top: 0; z-index: 2;">
                ...
                <th width="30" style="background-color: lightgreen; position: sticky; top: 0; z-index: 2;">
                    <div align="left" style="font-size: 14px;">Enpoint</div>
                </th>
                <th width="30" style="background-color: lightgreen; position: sticky; top: 0; z-index: 2;">
                    <div align="left" style="font-size: 14px;"> Hn </div>
                </th>
                <th width="150" style="background-color: lightgreen; position: sticky; top: 0; z-index: 2;">
        ...
        <tbody>
            <?php foreach ($visitProvider->getModels() as $key => $value) : ?>
                <tr>
                    <td><input type="checkbox" name="chkDel[]" id="chkDel<?= $key; ?>" value="<?= $value["visit"].$value["hn"]; ?>" style="width: 16px; height: 16px;"></td>
                    ...
                    <td class="text-nowrap" style="font-size: 14px; color: green;"><?= $value["claimcode"]; ?></td>
                    <td class="text-nowrap" style="font-size: 14px; color: orange;"><?= $value["enpoint"]; ?></td>
                    ...
                    <td class="text-nowrap" style="font-size: 14px;"><?= $value["inscl_name"]; ?></td>
