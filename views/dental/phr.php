...
$gridColumns = [
    ...
    [
        ...
        'format' => 'raw',
        'value'=> function ($model){
            return '<span class="btn btn-xs btn-success" style="background-color:#FF00FF">' . $model['T'] . '</span>';
        }
    ],
	 [
        'label' => 'จำนวนส่งไม่ผ่าน',
        'headerOptions'=>[ 'style'=>'background-color:#a4e7df'] ,
        'attribute' => 'F',
        'format' => 'raw',
        'value'=> function ($model){
            return '<span class="btn btn-xs btn-success" style="background-color:#FF0000">' . $model['F'] . '</span>';
        }
    ],
